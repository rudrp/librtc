...
(function($, window, document, undefined) {
	...
	// A reference to this object that can be accessed via all
	// scopes within the methods defined.
	var self = null;
	
	// This variable holds all of the method neccessary
	// to create a WebRTC coneection.
	var methods = {
		...
		init: function(options, elem) {
			...
			// Keep track of the element that will house WebRTC 
			// stuff.
			self.elem = elem;
			...
			// Initialize the socket variable. This is used to
			// connect to the signalling server.
			self.socket = null;
			
			// A mapping of connections to ids. This is to keep track
			// of to whom one is connected.
			self.peers = {};
			
			// Log to the console that the process has begun.
			console.log ( "Initializing" );
            self.createVideoConference();
			
		},
		
		createVideoConference: function() {
			...
			// If these elements do not exist then create them.
			// ...
		...
		createPeerConnection: function() {
			...
			try {
				...
				self.peerconn.addStream ( self.localVideo.stream );
	...
	$.fn.createWebRTC.options = {
		...
		signallingServer: "http://localhost:3000", 		// The address of the signalling server.
