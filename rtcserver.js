...
io.sockets.on ( 'connection', function(socket) {
  	...
  	socket.on ( 'message', function(message) {
		...
		switch ( message.type ) {
			...
			default:
				...
				//io.sockets.in ( message.channel ).broadcast.emit ( 'message', message );
	...
	socket.on ( 'subscribe', function(message) {
		...
		//io.sockets.in ( message.channel ).broadcast.emit ( 'message', { type: "hello" } );
		socket.broadcast.emit ( 'message', { type: "hello" } );
	...
	socket.on ( 'unsubscribe', function(message) {
		...
		//io.sockets.in ( message.channel ).broadcast.emit ( 'message', { type: "bye" } );
		socket.broadcast.emit ( 'message', { type: "bye" } );
